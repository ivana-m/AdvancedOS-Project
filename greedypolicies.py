...
def long(wrkld, spd, pwrusg, t1, t2):
    i1,j1,k1 = t1
    i2,j2,k2 = t2
    return wrkld[i1] > wrkld[i2]
...
def makelongshort(wrkld, spd, pwrusg, t1, t2):
    i1,j1,k1 = t1
    i2,j2,k2 = t2
    return wrkld[i1] * spd[i1][j1][k1] > wrkld[i2] * spd[i2][j2][k2]
...
def fastNeconomic(wrkld, spd, pwrusg, t1, t2):
    ...
    # but we make it like this to avoid zero division
    return pwrusg[i1][j1][k1] * spd[i2][j2][k2] < pwrusg[i2][j2][k2] * spd[i1][j1][k1]
...
def longNeconomic(wrkld, spd, pwrusg, t1, t2):
    i1,j1,k1 = t1
    i2,j2,k2 = t2
    # should be
    # return pwrusg[i1][j1][k1] / wrkld[i1] < pwrusg[i2][j2][k2] / wrkld[i2]
    # but we make it like this to avoid zero division
    return pwrusg[i1][j1][k1] * wrkld[i2] < pwrusg[i2][j2][k2] * wrkld[i1]
...
def longNeconomicNfast(wrkld, spd, pwrusg, t1, t2):
    i1,j1,k1 = t1
    i2,j2,k2 = t2
    # should be
    # return pwrusg[i1][j1][k1] /(spd[i1][j1][k1] * wrkld[i1]) < pwrusg[i2][j2][k2] /(spd[i2][j2][k2] * wrkld[i2])
    # but we make it like this to avoid zero division
    return pwrusg[i1][j1][k1] * spd[i2][j2][k2] * wrkld[i2] < pwrusg[i2][j2][k2] * spd[i1][j1][k1] * wrkld[i1]
